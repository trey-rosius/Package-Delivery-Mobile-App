...
/** This is an auto generated class representing the Geolocation type in your schema. */
class Geolocation {
  ...
  const Geolocation._internal({required latitude, required longitude}): _latitude = latitude, _longitude = longitude;
  
  factory Geolocation({required double latitude, required double longitude}) {
  ...
  Geolocation copyWithModelFieldValues({
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    modelSchemaDefinition.name = "Geolocation";
    modelSchemaDefinition.pluralName = "Geolocations";
